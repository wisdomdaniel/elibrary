...
const BookCard = ({ book, onClick }) => {
  return (
    <div
      onClick={onClick}
      className="flex-none w-56 bg-white rounded-[2rem] overflow-hidden border border-gray-100 hover:shadow-xl hover:shadow-gray-200/50 transition-all duration-300 group cursor-pointer flex flex-col h-full"
    >
      ...
      <div className="px-5 pb-6 flex-1 flex flex-col">
        ...
        <div className="flex items-center gap-2 text-[10px] font-bold text-gray-400 border-t border-gray-50 pt-3 mt-auto">
